import './App.css';
import logo from "./assets/images/logo_only_transparent.png"
import { Canvas} from '@react-three/fiber';
import Sphere from './assets/js/Sphere';
            ...
            <div className='Sidebar'>
              ...
              <div className='Sidebar-mid'>
                <nav>
                  ...
                  <a rel="My Skills" href="">My Skills</a>
                  <a rel="Contact" href="">Contact</a>
                  <a  className='Blog-button' rel="Blog" href="/Archives">Blog</a>
                </nav>
              </div>

              <ul className='Sidebar-footer'>
                <li>
                  <a href='https://github.com/CadeteSinx/'>
